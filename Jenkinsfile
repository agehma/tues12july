pipeline
{
    ...
    stages
    {
        stage('ContinuousDownload')
        {
            steps
            {
                git 'https://github.com/agehma/tues12july.git'
            }
        }
        ...
        stage('ContinuousTesting')
        {
            steps
            {
                ...
                sh 'java -jar /var/lib/jenkins/workspace/dp-pc/testing.jar'
            }
        }
    }
    post
    {
        ...
        failure
        {
           mail bcc: '', body: 'failed to deliver into prodserver', cc: '', from: '', replyTo: '', subject: 'delivery failed', to: 'anongeric2001@gmail.com' 
        }
    }
}
